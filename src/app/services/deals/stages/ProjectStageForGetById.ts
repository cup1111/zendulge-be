...
/**
 * Project stage for getById - selects final fields for output including sections and operatingHours
 */
export class ProjectStageForGetById implements PipelineStage {
